...
/* harmony import */ var _gerneral_components_numberOfImages_NumberOfImages__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../gerneral-components/numberOfImages/NumberOfImages */ "./block-editor/gerneral-components/numberOfImages/NumberOfImages.js");
...
function Edit(_ref) {
  ...
  const [gallery, setGallery] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useState)(attributes.galleryLabel ? attributes.galleryLabel : '');
  const [number, setNumber] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useState)(attributes.numberOfImages ? attributes.numberOfImages : '0');
  ...
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("fieldset", null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_gerneral_components_numberOfImages_NumberOfImages__WEBPACK_IMPORTED_MODULE_2__["default"], {
    value: number,
...
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./style.scss */ "./block-editor/blocks/gallery-block/style.scss");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./block.json */ "./block-editor/blocks/gallery-block/block.json");
/* harmony import */ var _edit__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./edit */ "./block-editor/blocks/gallery-block/edit.js");
/* harmony import */ var _save__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./save */ "./block-editor/blocks/gallery-block/save.js");
/**
    ...
    from: [{
      ...
      transform: _ref4 => {
        ...
        attributes.map(item => {
          ...
          let attName = ''; // since attributes have new names in the block, we need to match the old ones
...
function Autocomplete(_ref) {
  ...
  const [value, setValue] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useState)(preSelected);
  ...
  const [isLoading, setIsLoading] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useState)(false); // Unique ID for the input.
  ...
  }, isLoading && internalOptions.lenght <= 0 && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("li", {
    className: "loading"
...
/***/ "./block-editor/gerneral-components/numberOfImages/NumberOfImages.js":
/*!***************************************************************************!*\
  !*** ./block-editor/gerneral-components/numberOfImages/NumberOfImages.js ***!
  \***************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _numberOfImages_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./numberOfImages.scss */ "./block-editor/gerneral-components/numberOfImages/numberOfImages.scss");
...
function NumberOfImages(_ref) {
  ...
  const inputId = `nextcellent-block-number-of-images`; // Function to handle the onChange event.
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    value: value,
    onChange: onChangeValue
  }), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("p", null, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)("The number of images before pagination is applied. Leave empty or 0 for the default from the settings.", 'nggallery')));
}
...
/***/ "./block-editor/gerneral-components/numberOfImages/numberOfImages.scss":
/*!*****************************************************************************!*\
  !*** ./block-editor/gerneral-components/numberOfImages/numberOfImages.scss ***!
  \*****************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
module.exports = JSON.parse('{"$schema":"https://json.schemastore.org/block.json","apiVersion":2,"name":"nggallery/gallery-block","version":"0.1.0","title":"Gallery","category":"nextcellent-blocks","icon":"format-gallery","description":"","attributes":{"galleryLabel":{"type":"string"},"numberOfImages":{"type":"number","default":0}},"supports":{"html":false},"textdomain":"nggallery","editorScript":"file:../../../public/blocks/gallery-block/gallery-block.js","editorStyle":"file:../../../public/blocks/gallery-block/gallery-block.css","style":"file:../../../public/blocks/style-blocks/gallery-block/style-gallery-block.css"}');
